...
This is a basic example of an Agentless SP integration with PingFederate.  This provides
Single Log Out (SLO) for the SP adapter.
...
try
{
	...
	// You have resumePath and sessionid to help you kill the session

	String PARAM_RESUME_PATH = returnAttributes.get("resumePath");

	
	// 4 - Redirect to PF to continue SLO
