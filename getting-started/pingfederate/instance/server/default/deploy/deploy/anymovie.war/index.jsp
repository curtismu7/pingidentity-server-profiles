...
<html lang="en">
	<head>
		...
		<title>AnyProductionCompany</title>
		...
		<div id="site-content" style="background-image:url('showcase.jpg');background-position:center;background-size: 100%;">
			...
			<footer class="site-footer">
				<div class="container">
					...
					<div class="colophon">Copyright 2014 AnyProductionCompany, A Demo of AnyCompany, Designed by Themezy. All rights reserved</div>
				</div> <!-- .container -->
